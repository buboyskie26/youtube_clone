...
class VideoGrid {
    ...
    public function create($videos, $title, $showFilter){
        ...
        if($videos == null) {
            $gridItems = $this->generateWatchVideos();
        }
        else  if($videos != null){
            $gridItems = $this->generateVideosSubscription($videos);
        }
        ...
        if($title != null){
            $header = $this->createGridHeaderv2($title, $showFilter);
        }
    ...
    public function generateWatchVideos() {
    ...
    public function generateVideosSubscription($videos) {
        $elementsHtml = "";
    ...
    public function createLargeTwo($video, $title, $showFilter){
        $this->gridClass .= "large";
        $this->largeMode = true;
    ...
    public function createGridHeaderv2($title, $showFilter){
